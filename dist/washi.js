...
exports.Node = __webpack_require__(22).Node
;var assign;
((assign = __webpack_require__(23), exports.ResolvedPos = assign.ResolvedPos, exports.NodeRange = assign.NodeRange))
exports.Fragment = __webpack_require__(2).Fragment
;var assign$1;
((assign$1 = __webpack_require__(12), exports.Slice = assign$1.Slice, exports.ReplaceError = assign$1.ReplaceError))
exports.Mark = __webpack_require__(3).Mark

;var assign$2;
((assign$2 = __webpack_require__(52), exports.Schema = assign$2.Schema, exports.NodeType = assign$2.NodeType, exports.MarkType = assign$2.MarkType))
;var assign$3;
((assign$3 = __webpack_require__(21), exports.ContentMatch = assign$3.ContentMatch))

exports.DOMParser = __webpack_require__(51).DOMParser
exports.DOMSerializer =  __webpack_require__(53).DOMSerializer
...
;var assign;
((assign = __webpack_require__(13), exports.Selection = assign.Selection, exports.TextSelection = assign.TextSelection, exports.NodeSelection = assign.NodeSelection))

exports.Transaction = __webpack_require__(24).Transaction

exports.EditorState = __webpack_require__(56).EditorState

;var assign$1;
((assign$1 = __webpack_require__(55), exports.Plugin = assign$1.Plugin, exports.PluginKey = assign$1.PluginKey))
...
;var assign;
((assign = __webpack_require__(9), exports.Transform = assign.Transform, exports.TransformError = assign.TransformError))
;var assign$1;
((assign$1 = __webpack_require__(14), exports.Step = assign$1.Step, exports.StepResult = assign$1.StepResult))
;var assign$2;
((assign$2 = __webpack_require__(26), exports.joinPoint = assign$2.joinPoint, exports.canJoin = assign$2.canJoin, exports.canSplit = assign$2.canSplit, exports.insertPoint = assign$2.insertPoint, exports.liftTarget = assign$2.liftTarget, exports.findWrapping = assign$2.findWrapping))
;var assign$3;
((assign$3 = __webpack_require__(7), exports.StepMap = assign$3.StepMap, exports.MapResult = assign$3.MapResult, exports.Mapping = assign$3.Mapping))
;var assign$4;
((assign$4 = __webpack_require__(25), exports.AddMarkStep = assign$4.AddMarkStep, exports.RemoveMarkStep = assign$4.RemoveMarkStep))
;var assign$5;
((assign$5 = __webpack_require__(8), exports.ReplaceStep = assign$5.ReplaceStep, exports.ReplaceAroundStep = assign$5.ReplaceAroundStep))
__webpack_require__(57)
;var assign$6;
((assign$6 = __webpack_require__(58), exports.replaceStep = assign$6.replaceStep))
...
var Mark = ref$1.Mark;
var ref$2 = __webpack_require__(13);
...
var ref$1 = __webpack_require__(9);
var Transform = ref$1.Transform;
var ref$2 = __webpack_require__(8);
...
var ref$4 = __webpack_require__(15);
...
var _prosemirrorKeymap = __webpack_require__(49);

var _prosemirrorCommands = __webpack_require__(48);

var _prosemirrorState = __webpack_require__(1);

var _prosemirrorView = __webpack_require__(63);
...
var Editor = function () {
  function Editor(node) {
    ...
    var schema = new _prosemirrorModel.Schema(_Schema2.default);

    var state = _prosemirrorState.EditorState.create({
      schema: schema,

      plugins: [(0, _prosemirrorKeymap.keymap)(_prosemirrorCommands.baseKeymap)]
    });

    var view = new _prosemirrorView.EditorView(node, {
      state: state
    });
...
var _prosemirrorSchemaBasic = __webpack_require__(54);

var schema = {
  nodes: _prosemirrorSchemaBasic.nodes,
  marks: _prosemirrorSchemaBasic.marks
};
...
var mount = function mount(node) {
  return new _Editor2.default(node);
};
...
function joinBackward(state, dispatch, view) {
  ...
  for (var i = $cursor.depth - 1; !before && i >= 0; i--) { if ($cursor.index(i) > 0) {
...
function joinForward(state, dispatch, view) {
  ...
  for (var i = $cursor.depth - 1; !after && i >= 0; i--) {
...
var keyName = __webpack_require__(66)
var ref = __webpack_require__(1);
...
var OrderedMap = __webpack_require__(47)
...
var ref$2 = __webpack_require__(3);
var Mark = ref$2.Mark;
var ref$3 = __webpack_require__(21);
...
var ref$3 = __webpack_require__(8);
...
function fromClipboard(view, dataTransfer, plainText, $context) {
  ...
  var slice = parser.parseSlice(dom, {preserveWhitespace: true, context: $context}), context
...
var ref$1 = __webpack_require__(61);
...
var ref$5 = __webpack_require__(27);
var Decoration = ref$5.Decoration;
var viewDecorations = ref$5.viewDecorations;var assign;
((assign = __webpack_require__(27), exports.Decoration = assign.Decoration, exports.DecorationSet = assign.DecorationSet))
